          ...
          <div className="overflow-hidden rounded-2xl bg-[#1b1b1b] shadow-2xl">
            ...
            <div className="space-y-4 p-5">
              ...
              <div className="flex flex-wrap justify-start gap-2">
                {card.imdb && (
                  <span className="flex items-center rounded-full bg-yellow-900 px-3 py-1 text-xs text-yellow-300">
                    IMDb {card.imdb}
                  </span>
                )}
                {card.like && (
                  <span className="flex items-center rounded-full bg-yellow-900 px-3 py-1 text-xs text-green-500">
